...
| [Entity Distance](https://modrinth.com/mod/entity-distance) | Allows the user to adjust the (client) distance at which different entities render. | capnkork | Client |  [Github](https://github.com/capnkork/entity-distance/issues) | [Better Biome Blend](https://www.curseforge.com/minecraft/mc-mods/better-biome-blend) | Improves biome color blending | FionaTheMortal |  |  [Github](https://github.com/FionaTheMortal/Better-Biome-Blend/issues) 
